  ...
  <div class="navbar navbar-inverse navbar-fixed-top">
  	...
  	<div class="container">
  		...
  		<div class="collapse navbar-collapse">
            ...
            <!--addslashes is used to escape special characters. -->
        ...
        ?>
 			 ...
 			 <form class="marginTop" method="post">
				...
				<div class="form-group" >
  				...
  				<input id="age" type="password" title="Password should be 8 characters long. It should contains atleast one digit and letter. " name="password" class="form-control" placeholder="Password" value="<? echo addslashes($_POST['password']); ?>" />
